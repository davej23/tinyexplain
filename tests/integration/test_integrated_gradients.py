...
def test_object_detection():
    ...
    explainer = IntegratedGradients(model, TinyExplainTask.OBJECT_DETECTION, 10)
...
def test_image_classification():
    ...
    explainer = IntegratedGradients(model, TinyExplainTask.IMAGE_CLASSIFICATION, 10)
...
def test_tabular_data():
    ...
    explainer = IntegratedGradients(model, TinyExplainTask.TABULAR_DATA, 10)
...
def test_time_series():
    ...
    explainer = IntegratedGradients(model, TinyExplainTask.TIME_SERIES, 10)
    explanation = explainer.explain(
