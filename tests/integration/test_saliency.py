...
from tinyexplain.explain import Saliency
...
def test_object_detection():
    ...
    explainer = Saliency(model, TinyExplainTask.OBJECT_DETECTION)
...
def test_image_classification():
    ...
    explainer = Saliency(model, TinyExplainTask.IMAGE_CLASSIFICATION)
    explanation = explainer.explain(
...
def test_tabular_data():
    ...
    explainer = Saliency(model, TinyExplainTask.TABULAR_DATA)
    explanation = explainer.explain(
...
def test_time_series():
    ...
    explainer = Saliency(model, TinyExplainTask.TIME_SERIES)
    explanation = explainer.explain(
